    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">Kelola kategori untuk produk Anda</p>
        </div>
        <button
          onClick={() => handleOpenModal()}
          className="px-6 py-3 bg-gradient-to-r from-slate-600 to-slate-700 text-white rounded-xl font-semibold hover:shadow-lg transform hover:scale-105 transition-all"
        >
          + Tambah Kategori
        </button>
      </div>
        ...
        {categories.map((category) => (
          ...
          >
            <div className="flex items-start justify-between mb-4">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="p-2 text-slate-600 hover:bg-slate-50 dark:hover:bg-slate-900/30 rounded-lg transition-colors"
                  title="Edit"
                >
            ...
            <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-600 dark:text-gray-400">Total Produk</span>
      ...
      {categories.length === 0 && (
        <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Belum ada kategori</h3>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md mx-4">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                <button
                  type="submit"
                  className="flex-1 py-2.5 bg-slate-600 text-white rounded-lg font-semibold hover:bg-slate-700 transition-colors"
                >
