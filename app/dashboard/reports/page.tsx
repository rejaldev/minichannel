        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-slate-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white transition"
            />
          </div>
          <div>
            <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-gradient-to-br from-slate-500 to-slate-600 rounded-xl shadow-lg p-6 text-white">
          <div className="flex items-center justify-between mb-4">
            ...
            <p className="text-4xl font-bold">{summary?.totalTransactions || 0}</p>
          </div>
        ...
        <div className="bg-gradient-to-br from-amber-500 to-amber-600 rounded-xl shadow-lg p-6 text-white">
          <div className="flex items-center justify-between mb-4">
            ...
            <p className="text-4xl font-bold">{lowStockAlerts.length}</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {summary.paymentMethodBreakdown.map((method: any) => (
              <div
                ...
                className="border-2 border-gray-200 dark:border-gray-700 rounded-xl p-6 hover:border-slate-500 dark:hover:border-slate-400 transition bg-white dark:bg-gray-800"
              >
                <div className="flex items-center justify-between mb-4">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        ...
        {lowStockAlerts.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="mt-2 text-sm font-medium text-gray-900 dark:text-white">Semua stok aman!</p>
            <p className="text-sm text-gray-500 dark:text-gray-400">Tidak ada produk dengan stok menipis</p>
          </div>
        ) : (
