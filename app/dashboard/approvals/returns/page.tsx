  ...
  return (
    <div className="px-4 md:px-6">
      ...
      <nav className="flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-4 sm:mb-6">
        ...
        <span>›</span>
        <span className="font-semibold text-gray-900 dark:text-white">Pending Returns</span>
      </nav>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <div className="p-4 md:p-6 lg:p-8 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center space-x-3">
            <div className="flex items-center justify-center w-10 h-10 md:w-12 md:h-12 bg-orange-100 dark:bg-orange-900/30 rounded-xl">
              <RotateCcw className="w-5 h-5 md:w-6 md:h-6 text-orange-600 dark:text-orange-400" />
            </div>
            <div>
              <h2 className="text-lg md:text-xl font-bold text-gray-900 dark:text-white">Pending Returns</h2>
              <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400 mt-0.5">Approval permintaan return dari customer</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 md:p-6 lg:p-8">
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-md mx-auto">Fitur approval return sedang dalam pengembangan.</p>
            ...
            <div className="mt-8 max-w-2xl mx-auto">
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl border border-gray-200 dark:border-gray-600 p-6">
                ...
                <div className="space-y-3 text-left">
                  {[
                    { title: 'Review Return Request', desc: 'Lihat detail permintaan return' },
                    { title: 'Approve / Reject', desc: 'Setujui atau tolak return dengan alasan' },
                    { title: 'Auto Stock Update', desc: 'Stok otomatis update setelah approval' },
                    { title: 'Refund Processing', desc: 'Proses refund setelah return disetujui' },
                  ].map((item, i) => (
